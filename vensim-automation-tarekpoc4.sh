...
workloader pce-add -a --name default --fqdn poc4.illum.io --port 443 --api-user "$API_USER" --api-secret "$API_SECRET" --org "$ORG_ID" --disable-tls-verification true
...
vensim activate -c Tarek-Vensim-Lab/vens.csv -p Tarek-Vensim-Lab/processes.csv -m poc4.illum.io:443 -a "$SERVER_PK" -e "$ENDPOINT_PK"
